...
var helpers = {
  ...
  getTvInfo: function (){
    ...
    return fetchJsonp('https://api.themoviedb.org/3/tv/popular/?api_key=21b0daca9dad79653c91d176b7930bee&language=en-US&page=1&callback=test')
  ...
  .catch(function(ex) {
    console.log('GetTvInfo fetch Failure', ex)
  })
